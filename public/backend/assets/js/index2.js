$(function () {
  ...
  if (canvas) {
    ...
    // chart 10
    var canvas10 = document.getElementById('chart10');
    if (canvas10) {
      ...
      var myChart = new Chart(ctx, {
        type: 'line',
        data: {
          labels: ['Mon', 'Tue', 'Wed', 'Thu', 'Fr', 'Sa', 'Su'],
          datasets: [{
            label: 'Facebook',
    ...
    // chart 11
    var canvas11 = document.getElementById('chart11');
    if (canvas11) {
    ...
    // chart 12    
    var canvas12 = document.getElementById('chart12');
    if (canvas12) {
