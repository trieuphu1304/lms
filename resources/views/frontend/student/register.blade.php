        ...
        <div class="row">
            <div class="col-lg-7 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
                        <h3 class="card-title text-center fs-24 lh-35 pb-4">Tạo tài khoản và <br> Bắt đầu học!
                        </h3>
                        <div class="section-block"></div>
                        <form method="post" class="pt-4" action="{{ route('student.register.store') }}">
                            @csrf
                            ...
                            <div class="input-box">
                                <label class="label-text">Tên tài khoản</label>
                            ...
                            <div class="btn-box">
                                <div class="custom-control custom-checkbox mb-2 fs-15">
                                    ...
                                    <label class="custom-control-label custom--control-label lh-20"
                                        for="receiveCheckbox">Vâng! Tôi muốn tận dụng tối đa Aduca bằng cách nhận email
                                        với các ưu đãi độc quyền, gợi ý cá nhân và mẹo học tập!</label>

                                </div><!-- end custom-control -->
                                <div class="custom-control custom-checkbox mb-4 fs-15">
                                    <input type="checkbox" class="custom-control-input" id="agreeCheckbox">
                                    <label class="custom-control-label custom--control-label" for="agreeCheckbox">Bằng
                                        cách đăng ký, tôi đồng ý với
                                        <a href="terms-and-conditions.html" class="text-color hover-underline">điều
                                            khoản và điều kiện</a> và
                                        <a href="privacy-policy.html" class="text-color hover-underline">chính sách bảo
                                            mật</a>
                                    </label>

                                </div><!-- end custom-control -->
                                <button class="btn theme-btn" type="submit">Đăng kí <i
                                        class="la la-arrow-right icon ml-1"></i></button>
                                <p class="fs-14 pt-2">Đã có tài khoản? <a href="{{ route('student.login') }}"
