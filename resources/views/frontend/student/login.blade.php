            ...
            <div class="row">
                <div class="col-lg-7 mx-auto">
                    <div class="card card-item">
                        <div class="card-body">
                            <h3 class="card-title text-center fs-24 lh-35 pb-4">Đăng nhập tài khoản</h3>
                            <div class="section-block"></div>
                            <form method="post" class="pt-4" action="{{ route('login.submit') }}">
                                @csrf
                                    ...
                                    <div class="d-flex align-items-center justify-content-between pb-4">
                                        <div class="custom-control custom-checkbox fs-15">
                                            ...
                                            <label class="custom-control-label custom--control-label"
                                                for="rememberMeCheckbox">Ghi nhớ tôi</label>
