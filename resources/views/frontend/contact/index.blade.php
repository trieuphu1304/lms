        ...
        <div class="row">
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Địa chỉ của chúng tôi</h3>
                    <p class="info__text">Vườn lài Quận 12 TPHCM</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Email của chúng tôi</h3>
                    <p class="info__text">trieuphu130404@gmail.com</p>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Gọi cho chúng tôi</h3>
                    <p class="info__text">0869764432</p>
                    <p class="info__text"></p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
            ...
            <div class="col-lg-5">
                <div class="contact-content pb-5">
                    <div class="section-heading">
                        <h2 class="section__title pb-3">Chúng tôi rất vui vì đánh giá của bạn</h2>
                        <p class="section__desc">Đánh giá của bạn là động lực và kinh nghiệm để chúng tôi cải thiện mọi
                            thứ trở nên tốt hơn</p>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('contact.submit') }}" class="contact-form">
                            ...
                            <div class="alert alert-success contact-success-message" role="alert">
                                Cảm ơn, bạn đã gửi liên hệ thành công!
                            </div>
                            <div class="input-box">
                            ...
                            <div class="btn-box">
                                <button id="send-message-btn" class="btn theme-btn" type="submit">Gửi tin
                                    nhắn</button>
                            </div><!-- end btn-box -->
                        </form>
                    </div><!-- end card-body -->
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                L.marker([lat, lng]).addTo(map)
                                    .bindPopup("43/46 Vườn Lài, An Phú Đông, Q.12, TP.HCM")
                                    .openPopup();
                            });
                        </script>
