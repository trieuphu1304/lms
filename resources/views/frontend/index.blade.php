        ...
        <div class="row feature-content-wrap">
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Giảng Viên Chuyên Nghiệp</h3>
                    <p class="info__text">Đội ngũ giáo viên giàu kinh nghiệm và tận tâm, luôn sẵn sàng hỗ trợ bạn học
                        tập hiệu quả.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Giao Tiếp Dễ Dàng</h3>
                    <p class="info__text">Tương tác trực tiếp với giáo viên và học viên qua hệ thống nhắn tin và bình
                        luận tiện lợi.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <p class="info__text">Sau khi hoàn thành khóa học, bạn sẽ nhận được chứng chỉ công nhận kiến thức và
                        kỹ năng đạt được.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-3">
                <div class="category-btn-box text-right">
                    <a href="categories.html" class="btn theme-btn">Tất cả <i
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img class="cat__img lazy" src="{{ asset('frontend/images/img-loading.png') }}"
                            data-src="{{ asset('frontend/images/img1.jpg') }}">
        ...
        <ul class="nav nav-tabs generic-tab justify-content-center pb-4" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="business-tab" data-toggle="tab" href="#business" role="tab"
                    aria-controls="business" aria-selected="true">Kinh doanh</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="design-tab" data-toggle="tab" href="#design" role="tab"
                    aria-controls="design" aria-selected="false">Thiết kế</a>
            </li>
        </ul>
    </div><!-- end container -->
                    ...
                    <div class="row">
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                <div class="card-image">
                                    <a href="course-details.html" class="d-block">
                                        <img class="card-img-top lazy"
                                            ...
                                            data-src="{{ asset('frontend/images/img8.jpg') }}" alt="Ảnh khóa học">
                                    </a>
                                ...
                                <div class="card-body">
                                    <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">Mọi trình độ</h6>
                                    <h5 class="card-title"><a href="course-details.html">Khóa học Phân tích Dữ liệu
                                            Kinh doanh 2021</a></h5>
        ...
        <div class="row">
            <div class="col-lg-3 responsive-column-half">
                <div class="counter-item">
                    ...
                    <p class="counter__meta">Bài giảng</p>
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="counter-item">
                    ...
                    <p class="counter__meta">Người đăng kí</p>
                </div><!-- end counter-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="counter-item">
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="counter-item">
                    ...
                    <p class="counter__meta">Năm kinh nghiệm</p>
                </div><!-- end counter-item -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
...
<section class="cat-area pt-80px pb-80px bg-gray position-relative">
    ...
    <div class="container">
        <div class="cta-content-wrap text-center">
            <div class="section-heading">
                <h5 class="ribbon ribbon-lg mb-2">Bắt đầu học tập</h5>
                <h2 class="section__title fs-45 lh-55">Cải thiện kĩ năng với <br> Khóa học chất lượng</h2>
            </div><!-- end section-heading -->
            <div class="cat-btn-box mt-28px">
                <a href="sign-up.html" class="btn theme-btn">Bắt đầu <i class="la la-arrow-right icon ml-1"></i></a>
            </div><!-- end cat-btn-box -->
            ...
            <div class="col-lg-6">
                <div class="about-content pb-5">
                    <div class="section-heading">
                        ...
                        <h2 class="section__title">Lợi ích khi học ở Aduca</h2>
                        <span class="section-divider"></span>
                        <p class="section__desc">
                            Aduca mang đến trải nghiệm học tập hiện đại với phương pháp giảng dạy hiệu quả, giúp bạn
                            tiếp thu kiến thức nhanh chóng và phát triển toàn diện. Môi trường học thân thiện và hỗ trợ
                            tận tâm là điểm mạnh của chúng tôi.
                        </p>
                    ...
                    <div class="row pt-4 pb-3">
                        <div class="col-lg-4 responsive-column-half">
                            <div class="info-icon-box mb-3">
                                ...
                                <h4 class="fs-20 font-weight-semi-bold pt-3">130,000 khóa học</h4>
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="info-icon-box mb-3">
                                ...
                                <h4 class="fs-20 font-weight-semi-bold pt-3">Học trực tuyến</h4>
                            </div><!-- end info-icon-box -->
                        </div><!-- end col-lg-4 -->
                        <div class="col-lg-4 responsive-column-half">
                            <div class="info-icon-box mb-3">
                                ...
                                <h4 class="fs-20 font-weight-semi-bold pt-3">Giảng viên chuyên nghiệp</h4>
                            </div><!-- end info-icon-box -->
                        </div><!-- end col-lg-4 -->
                    </div><!-- end row -->
                    <div class="btn-box">
                        <a href="about.html" class="btn theme-btn">Học nhiều hơn <i
                                class="la la-arrow-right icon ml-1"></i></a>
                    </div><!-- end btn-box -->
    ...
    <div class="container">
        <div class="section-heading">
            ...
            <h2 class="section__title">Các công ty hàng đầu lựa chọn <a href="for-business.html"
                    class="text-color hover-underline">Aduca for Business</a> để phát triển
                <br> các kỹ năng nghề nghiệp đang được săn đón
            </h2>
...
<section class="blog-area section--padding bg-gray overflow-hidden">
    <div class="container">
        <div class="section-heading text-center">
            <h5 class="ribbon ribbon-lg mb-2">Bảng tin mới</h5>
            <h2 class="section__title">Bài viết và thông báo mới</h2>
            <span class="section-divider"></span>
        </div><!-- end section-heading -->
        <div class="blog-post-carousel owl-action-styled half-shape mt-30px">
            <div class="card card-item">
                <div class="card-image">
                    ...
                    <div class="course-badge-labels">
                        <div class="course-badge">24 Tháng 1, 2020</div>
                    </div>
                </div><!-- end card-image -->
                <div class="card-body">
                    <h5 class="card-title"><a href="blog-single.html">Đào tạo kỹ năng bán hàng: Kỹ thuật thực tiễn</a>
                    </h5>
                    <ul
                        class="generic-list-item generic-list-item-bullet generic-list-item--bullet d-flex align-items-center flex-wrap fs-14 pt-2">
                        <li class="d-flex align-items-center">Bởi <a href="#">TechyDevs</a></li>
                        <li class="d-flex align-items-center"><a href="#">4 bình luận</a></li>
                        <li class="d-flex align-items-center"><a href="#">130 lượt thích</a></li>
                    </ul>
                    <div class="d-flex justify-content-between align-items-center pt-3">
                        <a href="blog-single.html" class="btn theme-btn theme-btn-sm theme-btn-white">Đọc thêm <i
                                class="la la-arrow-right icon ml-1"></i></a>
                        <div class="share-wrap">
                            ...
                            <div class="icon-element icon-element-sm shadow-sm cursor-pointer share-toggle"
                                title="Chia sẻ"><i class="la la-share-alt"></i></div>
                        </div>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
            ...
            <div class="card card-item">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a href="blog-single.html">Khóa học Photoshop toàn diện: Từ người mới bắt
                            đầu</a></h5>
                    <ul
                        class="generic-list-item generic-list-item-bullet generic-list-item--bullet d-flex align-items-center flex-wrap fs-14 pt-2">
                        <li class="d-flex align-items-center">Bởi <a href="#">TechyDevs</a></li>
        ...
        <div class="row">
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        <img src="{{ asset('frontend/images/img-loading.png') }}"
                            data-src="{{ asset('frontend/images/small-img-2.jpg') }}" alt="Hình thẻ"
                            class="img-fluid rounded-full lazy">
                        <h5 class="card-title pt-4 pb-2">Trở thành Giảng viên</h5>
                        <p class="card-text">Dạy điều bạn yêu thích. Aduca cung cấp cho bạn công cụ để tạo khóa học của
                            riêng mình.</p>
                        <div class="btn-box mt-20px">
                            <a href="#" class="btn theme-btn theme-btn-sm theme-btn-white lh-30"><i
                                    class="la la-user mr-1"></i>Bắt đầu giảng dạy</a>
                        </div><!-- end btn-box -->
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        <img src="{{ asset('frontend/images/img-loading.png') }}"
                            data-src="{{ asset('frontend/images/small-img-3.jpg') }}" alt="Hình thẻ"
                            class="img-fluid rounded-full lazy">
                        <h5 class="card-title pt-4 pb-2">Trở thành Học viên</h5>
                        <p class="card-text">Học điều bạn yêu thích! Thay đổi cuộc sống của bạn thông qua giáo dục và
                            rèn luyện tư duy</p>
                        <div class="btn-box mt-20px">
                            <a href="#" class="btn theme-btn theme-btn-sm theme-btn-white lh-30"><i
                                    class="la la-file-text-o mr-1"></i>Bắt đầu học</a>
                        </div><!-- end btn-box -->
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-s text-center">
                    <div class="card-body">
                        <img src="{{ asset('frontend/images/img-loading.png') }}"
                            data-src="{{ asset('frontend/images/small-img-4.jpg') }}" alt="Hình thẻ"
                            class="img-fluid rounded-full lazy">
                        <h5 class="card-title pt-4 pb-2">Aduca cho Doanh nghiệp</h5>
                        <p class="card-text">Truy cập không giới hạn hơn 5.000+ khóa học hàng đầu từ Aduca cho đội ngũ
                            của bạn.</p>
                        <div class="btn-box mt-20px">
                            <a href="#" class="btn theme-btn theme-btn-sm theme-btn-white lh-30"><i
                                    class="la la-briefcase mr-1"></i>Dành cho doanh nghiệp</a>
                        </div><!-- end btn-box -->
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
