						...
						<div class="card-header">
						  ...
						  <div class="card-body">
							...
							<div class="chart-container-1">
								<canvas id="chart1" width="1333" height="390" style="display: block; box-sizing: border-box; height: 260px; width: 888px;"></canvas>
							  </div>
						  </div>
						...
						<div class="card-header">
						   ...
						   <div class="card-body">
							<div class="chart-container-2">
								<canvas id="chart2" width="624" height="330" style="display: block; box-sizing: border-box; height: 220px; width: 416px;"></canvas>
							  </div>
						   </div>
                           ...
                           <div class="card radius-10 w-100">
							   <div class="card-body">
								...
								<div class="chart-container-0 mt-5">
									<canvas id="chart3" width="624" height="480" style="display: block; box-sizing: border-box; height: 320px; width: 416px;"></canvas>
								  </div>
							   </div>
						   </div>
						 </div>
							...
							<div class="card radius-10 w-100">
								...
								<div class="card-body">
									<div class="chart-container-1 mt-3">
										<canvas id="chart4" width="624" height="390" style="display: block; box-sizing: border-box; height: 260px; width: 416px;"></canvas>
									  </div>
								</div>
								<ul class="list-group list-group-flush">
							...
							<div class="card radius-10 w-100">
								...
								<div class="card-body">
								   <div class="chart-container-0">
									 <canvas id="chart5" width="624" height="480" style="display: block; box-sizing: border-box; height: 320px; width: 416px;"></canvas>
								   </div>
								</div>
