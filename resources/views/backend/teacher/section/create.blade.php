<div class="content container-fluid">
    <div class="page-header mb-4">
        <h3 class="page-title text-primary fw-semibold">Thêm Chương Học Mới</h3>
    </div>
    ...
    <form action="{{ route('teacher.section.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card border-0 shadow-sm rounded-4">
            ...
            <div class="card-body bg-white">
                <div class="mb-3">
                    ...
                    <input type="text" name="title" class="form-control rounded-3"
                        placeholder="VD: Giới thiệu khóa học,..." required>
                </div>
            ...
            <div class="card-footer bg-light-purple text-end rounded-bottom-4">
                ...
                <button type="submit" class="btn btn-primary rounded-3">
                    <i class="bx bx-save"></i> Lưu chương học
                </button>
            </div>
        </div>
    </form>
